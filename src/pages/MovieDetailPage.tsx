    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {movie.backdrop_path && (
        <div className="relative h-96 md:h-[500px] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-t from-gray-50 via-gray-50/50 to-transparent z-10" />
          <img
      ...
      <div className="container mx-auto px-4 -mt-64 relative z-20">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-white bg-black bg-opacity-50 hover:bg-opacity-70 px-4 py-2 rounded-lg mb-6 transition-all"
        >
